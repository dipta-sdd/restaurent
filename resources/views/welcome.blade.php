...
<body>
        ...
        <nav class="navbar navbar-expand-lg customNav">
            <div class="container-fluid">
                <a class="navbar-brand d-flex align-items-center" href="#">
                    <img src="/Images/logo.png" class="nav__logo" alt="logo">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="customItem" href="pricing.html">Reservations</a>
                        </li>
                        <li class="nav-item">
                            <a class="customItem" href="#">Contact</a>
                        </li>
                        @if (Auth::user())
        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./Images/slider_1.jpg" class="d-block w-100" alt="Slider Image 1">
                    <div class="carousel-caption d-none d-md-block">
                        <h2>Welcome to</h2>
                        <h5>BENGAL TANDOORI RESTAURANT</h5>
                        <p>Experience the flavors of our exquisite cuisine.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="./Images/slider_2.jpg" class="d-block w-100" alt="Slider Image 2">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img src="./Images/slider_3.jpg" class="d-block w-100" alt="Slider Image 3">
                    <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-check"></i> Fresh, local ingredients</li>
                                <li><i class="fas fa-check"></i> Authentic recipes</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <ul class="list-unstyled">
                                <li><i class="fas fa-check"></i> Cozy ambiance</li>
                                <li><i class="fas fa-check"></i> Friendly service</li>
                            </ul>
                        </div>
                    </div>
                    <a href="#" class="btn btn-primary mt-4 w-100">Learn More</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="menu py-5">
        <div class="container scaleup">
            <h2 class="text-center mb-5 heading_h2 display-4 scaleup">Our Menu</h2>
            <div class="menu-grid">
                <div class="grid-item">
    ...
    <section class="reservation-section py-5">
        <div class="container">
            <h2 class="text-center mb-4 heading_h2 display-4 py-3">Reserve Your Table</h2>
            <div class="reservation-container">
                <div class="reservation-image">
                    <img src="./Images/3914790.jpg" alt="Restaurant Table" class="img-fluid" />
                </div>
                <div class="reservation-form">
                    <form action="#" method="post">
                        <h3 class="form-heading text-center mb-4">Book Your Table</h3>
                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-lg btn-primary m-0">Reserve Now</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section class="testimonials py-5">
        <div class="container">
            <h2 class="text-center mb-5 heading_h2 display-4">What Our Guests Say</h2>
                ...
                <div class="testimonial-slider">
                    <div class="testimonial-slide">
                        ...
                        <div class="testimonial-content">
                            <p>"The food was incredible, the service was impeccable..."</p>
                    ...
                    <div class="testimonial-slide">
                        ...
                        <div class="testimonial-content">
                            <p>"This restaurant exceeded our expectations! The dishes..."</p>
                    ...
                    <div class="testimonial-slide">
                        ...
                        <div class="testimonial-content">
                            <p>"We had a wonderful dining experience. The food was..."</p>
                            <div class="testimonial-author">- Peter Jones</div>
                        </div>
                    </div>
                    <div class="testimonial-slide">
                        <div class="testimonial-image">
                        ...
                        <div class="testimonial-content">
                            <p>"Absolutely loved the atmosphere and the delicious meals..."</p>
                            <div class="testimonial-author">- Anna Brown</div>
                        </div>
                    </div>
                    <div class="testimonial-slide">
                        <div class="testimonial-image">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-info">
                        <h2 class="mb-4 heading_h2 display-3">Get in Touch</h2>
                        ...
                        <div class="contact-item">
                            ...
                            <p><strong>Opening Hours:</strong><br> Mon - Fri: 10:00 AM - 10:00 PM<br> Sat - Sun: 12:00
                                PM - 11:00 PM</p>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer bg-dark text-white pt-5">
        ...
        <div class="footer-bottom text-center py-3">
            <p class="mb-0">&copy; 2024 Restaurant Name. All Rights Reserved. <a href="#"
                    class="text-white text-decoration-none">Terms</a> | <a href="#"
                    class="text-white text-decoration-none">Privacy Policy</a></p>
        </div>
    </footer>
    ...
    <div class="modal fade" id="openingModal" tabindex="-1" aria-labelledby="openingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header text-center" style="background: linear-gradient(to right, #082A45, #073d69);">
                    <h5 class="modal-title w-100 text-white fw-bold" id="openingModalLabel">Welcome to Our Restaurant
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <p class="fw-bold fs-4">Opening Time: <span class="text-primary">10:00 AM</span></p>
                    <p class="fw-bold fs-4">Closing Time: <span class="text-danger">11:00 PM</span></p>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            const openingModal = new bootstrap.Modal(document.getElementById('openingModal'));
            openingModal.show();
        });
