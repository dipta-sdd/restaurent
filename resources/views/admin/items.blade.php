                ...
                <div class="card mb-4 p-none" id="manage_item">
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation">
                            @csrf
                            <div class="col-md-6">
                                <label for="subcategory_id" class="form-label">Subcategory <small
                            ...
                            <div class="col-md-6">
                                <label for="name" class="form-label">Item Name <small
                                        class="text-danger">*</small></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="file" id="item_image" class="form-control" name="item_image"
                                        accept="image/*">
                                ...
                                <div id="existing-image-container" class="mt-2" style="display:none;">
                                    ...
                                    <img id="existing-image" src="" alt="Existing Image" class="img-fluid"
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody class="items-table text-capitalize" id="itemsTbody">
                                            ...
                                            <tr id="tr-{{ $item->id }}">
                                                ...
                                                <td data-val="{{ $item->subcategory_id }}">{{ $item->subcategory_name }}
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#itemsTbody .btn.btn-primary.edit', function(e) {
                ...
                const data = {
                    ...
                    image: tr.find('td').eq(1).find('img').attr('src'),
            ...
            $('#manage_item form .update').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $row.find('td').eq(5).text(response.subcategory_name);
                        $row.find('td').eq(6).text(response.allergens ?? "N/A");
                        $row.find('td').eq(7).text(response.dietary_options ?? "N/A");
                        // $row.find('td').eq(10).text(response.updated_by);
                        $row.find('td').eq(11).text(myDateFormat(response.updated_at));
