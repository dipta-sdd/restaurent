OK, here are all of your user stories, with reassigned serial numbers based on a logical order of completion, and some new user stories added where relevant:
